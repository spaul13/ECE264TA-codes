...
This assignment asks you to shuffle cards only once. The next
assignment asks you to shuffle cards multiple times.  Please read both
parts so that you can reuse part 1 as much as possible.
